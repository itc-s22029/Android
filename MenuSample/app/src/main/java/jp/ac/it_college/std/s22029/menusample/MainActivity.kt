...
import jp.ac.it_college.std.s22029.menusample.databinding.ActivityMainBinding

class MainActivity : AppCompatActivity() {
    private lateinit var binding: ActivityMainBinding
    private val menuList = mutableListOf<jp.ac.it_college.std.s22029.menusample.Menu>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // toolbar  をactionBarとして使うtoolbar
    ...
    private fun resetMenu(list: List<jp.ac.it_college.std.s22029.menusample.Menu>): Boolean {
        menuList.clear()
